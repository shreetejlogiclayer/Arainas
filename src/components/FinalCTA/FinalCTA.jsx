...
const FinalCTA = () => {
  ...
  return (
    <section
      className="py-24 bg-gradient-to-b from-araina-white via-araina-pink/5 to-araina-blue/10 relative overflow-hidden"
    >
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-araina-black/70 font-light leading-relaxed max-w-2xl mx-auto mb-10">
            Araina is where health meets empowerment, confidence meets opportunity, and every woman is inspired to rise toward a healthier, more confident, and self-dependent future.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              onClick={() => handleScrollTo('product')}
              className="bg-araina-pink hover:bg-araina-pink/90 text-araina-white text-xs uppercase tracking-widest font-bold px-8 py-4 rounded-full transition-all duration-300 transform hover:-translate-y-[2px] active:translate-y-0 shadow-md shadow-araina-pink/20 flex items-center justify-center gap-2 w-full sm:w-auto"
            >
