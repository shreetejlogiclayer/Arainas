          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            >
              <p>
                ...
                health and financial security can affect women, families, and
                communities. We saw the importance of health more clearly than
                ever. At the same time, we saw businesses and jobs disappear and
                the financial situation of many families become uncertain.
              </p>
              <p>
                These experiences made us look at women's well-being from a
                broader perspective. A woman needs to take care of her health.
                She needs access to awareness and informed choices. But she also
                needs opportunities to build confidence, develop skills, and
                work towards financial independence. Why should these two needs
                exist separately?
              </p>
              <p>
                That question became the foundation of our vision. We wanted to
                bring better care for women's health together with meaningful
                opportunities for women to learn, grow, and become financially
                stronger. That led to the creation of Royo Essentials LLP and
                Araina as our flagship brand.
              </p>
            </motion.div>
          </div>
        </div>
