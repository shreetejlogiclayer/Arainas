...
const MissionVision = () => {
  return (
    <section
      id="mission-vision"
      className="py-24 bg-araina-white relative overflow-hidden border-t border-araina-pink/5 butterfly-background section-divider"
    >
            ...
            >
              ...
              <div className="space-y-4 text-xs sm:text-sm text-araina-black/60 font-light leading-relaxed">
                <p>
                  ...
                  hygienic, quality-focused feminine wellness and personal-care
                  products.
                </p>
                <p>
                  • <strong>Creating Opportunity:</strong> Providing a platform
                  through which women can learn, start their own small
                  entrepreneurial journey, and earn with dignity.
                </p>
                <p>
                  • <strong>Spreading Awareness:</strong> Encouraging open
                  conversations and positive awareness about menstrual health.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="pt-12 md:pt-0 md:pl-12 flex flex-col justify-start">
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-araina-black/60 font-light leading-relaxed mb-4">
                ...
                reliable feminine hygiene, understands the importance of her own
                health, and has the confidence and opportunity to build a
