...
import { Heart, Shield, Sparkles, Compass, Activity, ShieldCheck, HeartHandshake, Banknote, Home, Users, ArrowRight, Check } from 'lucide-react';
...
const WhyUsPage = () => {
  ...
  const pillars = [
    {
      title: 'Comfort',
      description: "Thoughtfully positioned menstrual care designed around women's needs, offering premium softness, breathability, and ergonomic security.",
      icon: Heart,
      badge: 'Ergonomic Design'
    },
    {
      title: 'Hygiene',
      description: 'A focus on safe, responsible menstrual care with strict quality standards and touch-free automated manufacturing practices.',
      icon: Shield,
      badge: 'Touch-Free Process'
    },
    {
      title: 'Confidence',
      description: 'Helping women experience their periods with confidence and comfort, rather than compromise, fear, or limitations.',
      icon: Sparkles,
      badge: 'Pure Peace of Mind'
    },
    {
      title: 'Empowerment',
      description: "Connecting women's health with entrepreneurship, learning, and meaningful financial opportunities to rise together.",
      icon: Compass,
  ...
  const steps = [
    { title: 'Better Health', desc: 'Quality feminine care and menstrual hygiene awareness as the essential foundation.', icon: Activity },
    { title: 'Greater Confidence', desc: 'Approaching everyday life and choices with comfort, free from fear or limitations.', icon: ShieldCheck },
    { title: 'Meaningful Opportunity', desc: 'Flexible business platforms that allow women to learn and grow at their own pace.', icon: HeartHandshake },
    { title: 'Financial Independence', desc: 'Developing skills, earning with dignity, and taking control of their own futures.', icon: Banknote },
    { title: 'Stronger Families', desc: 'When a woman is empowered, she strengthens her household and sets a new example.', icon: Home },
    { title: 'Stronger Communities', desc: 'Progress that inspires others, turning individual growth into collective upliftment.', icon: Users },
  ];

  const reasons = [
    { title: 'No Fear-Based Marketing', text: 'We communicate transparently and respectfully without using fear tactics or exaggerated medical claims.' },
    { title: 'Holistic Approach', text: 'We look at women health alongside skill development and financial self-reliance.' },
    { title: 'Quality-First Engineering', text: 'Every pad features an 8-layer absorbency system designed for modern active lifestyles.' },
    { title: 'Dignified Opportunity', text: 'Flexible pathways for homemakers, career returnees, and women seeking entrepreneurial growth.' }
  ];
    ...
    <div className="pt-24 pb-20 min-h-screen bg-araina-white text-araina-black">
      ...
      <section className="relative py-16 lg:py-24 bg-gradient-to-tr from-araina-white via-araina-pink/5 to-araina-blue/5 overflow-hidden border-b border-araina-pink/10">
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center max-w-3xl mx-auto">
          ...
          >
            We believe a woman deserves more than just a product. She deserves care that respects her dignity, knowledge that empowers her, and choices that support her wellness.
          </motion.p>
        </div>
      </section>
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <h4 className="text-sm font-bold text-araina-black mb-1">{step.title}</h4>
                    <p className="text-xs text-araina-black/65 font-light leading-relaxed">{step.desc}</p>
                  </div>
                </div>
              );
            })}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="text-sm sm:text-base text-araina-black/75 font-light leading-relaxed mb-8">
                Our approach is rooted in honesty, quality products, transparent communication, and genuine empowerment rather than hollow marketing gimmicks.
              </p>

              <div className="space-y-4">
                {reasons.map((r, idx) => (
                  <div key={idx} className="flex items-start gap-3 p-4 bg-araina-pink/5 rounded-2xl border border-araina-pink/10">
                    <div className="w-6 h-6 rounded-full bg-araina-pink text-white flex items-center justify-center shrink-0 mt-0.5">
                      <Check size={14} />
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-araina-black mb-0.5">{r.title}</h4>
                      <p className="text-xs text-araina-black/70 font-light">{r.text}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="lg:col-span-6">
              <div className="bg-gradient-to-tr from-araina-pink via-araina-pink/90 to-araina-blue text-araina-white rounded-3xl p-8 sm:p-12 shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold mb-6 leading-tight">
                  "Every woman deserves to experience period care with confidence, dignity, and choice."
                </h3>
                <p className="text-xs sm:text-sm font-light text-white/90 leading-relaxed mb-8">
                  Royo India LLP is committed to creating products and opportunities that build long-term value for women, families, and society.
                </p>
                <Link
                  to="/contact"
