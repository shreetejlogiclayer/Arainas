...
import { Mail, Phone, MapPin, Clock, MessageCircle, Send, CheckCircle2, AlertCircle, Loader2 } from 'lucide-react';
import { InstagramIcon, FacebookIcon, YoutubeIcon } from '../components/SocialIcons/SocialIcons';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (hasEmailJsKeys) {
        ...
        setStatusMessage('Thank you! Your message has been sent successfully. Our team will get back to you shortly.');
        setFormData({
          user_name: '',
          user_email: '',
          user_phone: '',
      ...
      setStatusMessage('Unable to send message at this moment. Please try again or reach out directly via WhatsApp.');
    } finally {
    ...
    <div className="pt-24 pb-20 min-h-screen bg-araina-white text-araina-black">
      ...
      <section className="relative py-16 lg:py-24 bg-gradient-to-tr from-araina-white via-araina-pink/5 to-araina-blue/5 overflow-hidden border-b border-araina-pink/10">
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center max-w-3xl mx-auto">
          ...
          >
            Have a question about ARAINA products, need more information about our mission, or want to explore business and community opportunities? Reach out to our team.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="bg-gradient-to-br from-araina-pink/5 via-araina-white to-araina-blue/5 border border-araina-pink/15 rounded-3xl p-8 shadow-sm">
                ...
                <h3 className="text-xl font-bold text-araina-black mb-1">{COMPANY_INFO.name}</h3>
                ...
                <div className="space-y-4 text-xs font-light text-araina-black/80">
                  <div className="flex items-start gap-3">
                    <Mail size={18} className="text-araina-pink shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold block text-araina-black">Email Address</span>
                      <a href={`mailto:${COMPANY_INFO.email}`} className="hover:text-araina-pink transition-colors">
                        {COMPANY_INFO.email}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <Phone size={18} className="text-araina-blue shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold block text-araina-black">Phone Number</span>
                      <a href={`tel:${COMPANY_INFO.phone}`} className="hover:text-araina-blue transition-colors">
                        {COMPANY_INFO.phone}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <MapPin size={18} className="text-araina-pink shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold block text-araina-black">Office Location</span>
                      <span>{COMPANY_INFO.address}</span>
                    </div>
                  </div>

                  <div className="flex items-start gap-3">
                    <Clock size={18} className="text-araina-blue shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold block text-araina-black">Business Hours</span>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                  <h4 className="text-sm font-bold text-emerald-900 flex items-center gap-2">
                    <MessageCircle className="text-emerald-600 fill-emerald-100" size={20} />
                    Instant WhatsApp Support
                  </h4>
                  <p className="text-xs text-emerald-800/80 font-light mt-1">
                    Connect directly with our team on WhatsApp for quick responses.
                  </p>
                </div>
                <a
                  href={whatsappUrl}
            ...
            <div className="lg:col-span-7">
              <div className="bg-araina-white border border-araina-pink/15 rounded-3xl p-8 sm:p-12 shadow-lg relative">
                ...
                <p className="text-xs sm:text-sm text-araina-black/60 font-light leading-relaxed mb-8">
                  Fill out the form below. Our customer support team will process your enquiry promptly.
                </p>
                ...
                <AnimatePresence mode="wait">
                  {submitStatus === 'success' ? (
                    ...
                    >
                      ...
                      <h3 className="text-lg font-bold text-emerald-900 mb-2">Message Received!</h3>
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="space-y-6" noValidate>
                      ...
                      {/* Full Name */}
                      <div>
                        <label htmlFor="user_name" className="block text-xs uppercase font-bold tracking-wider text-araina-black mb-2">
                        ...
                        <input
                          ...
                          className={`w-full bg-araina-pink/5 border ${
                            errors.user_name ? 'border-rose-500' : 'border-araina-pink/15'
                        ...
                        />
                        {errors.user_name && (
                          <span className="text-[11px] text-rose-500 mt-1 block">{errors.user_name}</span>
                        )}
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                          <label htmlFor="user_email" className="block text-xs uppercase font-bold tracking-wider text-araina-black mb-2">
                          ...
                          <input
                            ...
                            disabled={isSubmitting}
                            className={`w-full bg-araina-pink/5 border ${
                              errors.user_email ? 'border-rose-500' : 'border-araina-pink/15'
                            } rounded-2xl px-5 py-3.5 text-xs sm:text-sm text-araina-black focus:outline-none focus:border-araina-pink transition-all font-light`}
                          />
                          {errors.user_email && (
                            <span className="text-[11px] text-rose-500 mt-1 block">{errors.user_email}</span>
                          )}
                        </div>

                        <div>
                          <label htmlFor="user_phone" className="block text-xs uppercase font-bold tracking-wider text-araina-black mb-2">
                            Phone Number
                          </label>
                          <input
                            id="user_phone"
                      ...
                      {/* Subject dropdown */}
                      <div>
                        <label htmlFor="subject" className="block text-xs uppercase font-bold tracking-wider text-araina-black mb-2">
                        ...
                        <select
                          ...
                          className="w-full bg-araina-pink/5 border border-araina-pink/15 rounded-2xl px-5 py-3.5 text-xs sm:text-sm text-araina-black focus:outline-none focus:border-araina-pink transition-all font-light"
                        >
                          <option value="Product Inquiry">Product Inquiry (Araina Pads)</option>
                          <option value="Business / Distribution">Business & Distribution Enquiry</option>
                          <option value="Women Opportunity Program">Araina Women Opportunity</option>
                      ...
                      {/* Message Textarea */}
                      <div>
                        <label htmlFor="message" className="block text-xs uppercase font-bold tracking-wider text-araina-black mb-2">
                          Your Message <span className="text-araina-pink">*</span>
                        </label>
                        <textarea
                          id="message"
                          name="message"
                          ...
                          disabled={isSubmitting}
                          className={`w-full bg-araina-pink/5 border ${
                            errors.message ? 'border-rose-500' : 'border-araina-pink/15'
